  ...
  return (
    <section className="bg-surface/60 bg-[#f3eeef] h-[80vh] border-b border-slate-200">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <ParallaxSection className="mt-10 w-[50%] mx-auto">
          <motion.div 
          ...
          >
          <div className="px-4 py-4 text-xs  flex justify-between">
            <div className="dots flex gap-1 ">
              <motion.li 
                className=" w-[9px] h-[9px] bg-primary list-none rounded-full"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{ duration: 0.3, delay: 0.7 }}
              ></motion.li>
              <motion.li 
                className=" w-[9px] h-[9px]  bg-[#14B8A6] list-none rounded-full"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{ duration: 0.3, delay: 0.8 }}
              ></motion.li>
              <motion.li 
                className=" w-[9px] h-[9px]  bg-[#F87171] list-none rounded-full"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
          ...
          <pre className="px-4 pb-4 text-sm">
            <code>
              <motion.h2 
