...
const projects = [
  {
    ...
    description:
      "ZAYID is a scalable multi-category auction platform with real-time bidding .......",
    ...
    <main>
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            We're a diverse group of creators, problem-solvers, and technology
            enthusiasts united by our passion for building exceptional digital
            experiences.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            Explore our latest work showcasing innovative solutions, clean code,
            and beautiful design across various industries and platforms.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <a
              href="/projects"
              className="inline-block px-4 py-2 bg-primary text-white rounded-[12px] text-sm hover:shadow-lg transition-all duration-300 hover:scale-105"
            >
              View All Projects →
            </a>
          </motion.div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            We offer comprehensive digital solutions from initial concept to
            final deployment, ensuring your project succeeds at every stage of
            development.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
